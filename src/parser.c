...
enum {
  ...
  sym_this = 86,
  anon_sym_DOT = 87,
  sym_decimal_integer_literal = 88,
  sym_true = 89,
  sym_false = 90,
  ...
  sym_method_parameters = 115,
  sym_method_parameter = 116,
  sym__type = 117,
  ...
  sym_method_body = 122,
  sym__annotation = 123,
  sym__unannotated_type = 124,
  sym_dimensions = 125,
  aux_sym_source_file_repeat1 = 126,
  aux_sym_modifiers_repeat1 = 127,
  aux_sym__annotated_type_repeat1 = 128,
  aux_sym_dimensions_repeat1 = 129,
};
...
static const char * const ts_symbol_names[] = {
  ...
  [aux_sym__annotated_type_repeat1] = "_annotated_type_repeat1",
...
static const TSSymbol ts_symbol_map[] = {
  ...
  [aux_sym__annotated_type_repeat1] = aux_sym__annotated_type_repeat1,
...
static const TSSymbolMetadata ts_symbol_metadata[] = {
  ...
  [aux_sym__annotated_type_repeat1] = {
    .visible = false,
    .named = false,
  },
  ...
  switch (state) {
    ...
    case 7:
      ...
      if (lookahead == '\t' ||
          ...
          lookahead == '\r' ||
          lookahead == ' ') SKIP(7)
      if (sym_identifier_character_set_1(lookahead)) ADVANCE(391);
      END_STATE();
    case 8:
    ...
    case 391:
      ...
      if (sym_identifier_character_set_2(lookahead)) ADVANCE(391);
      END_STATE();
    case 392:
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [32] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_modifiers_repeat1, 2), SHIFT_REPEAT(7),
  ...
  [56] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class_body, 3),
  [58] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class_declaration, 3, .production_id = 1),
  [60] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class_body, 2),
  [62] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class_declaration, 4, .production_id = 2),
  [64] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_dimensions_repeat1, 2),
  [66] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_dimensions_repeat1, 2), SHIFT_REPEAT(7),
  [69] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_dimensions_repeat1, 2), SHIFT_REPEAT(34),
  [72] = {.entry = {.count = 1, .reusable = true}}, SHIFT(34),
  [74] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dimensions, 1),
  [76] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__annotated_type_repeat1, 2), SHIFT_REPEAT(7),
  [79] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__annotated_type_repeat1, 2),
  [81] = {.entry = {.count = 1, .reusable = true}}, SHIFT(35),
  [83] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_dimensions_repeat1, 3),
  [85] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_primitive_type, 1),
  [87] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__type, 1),
  [89] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__unannotated_type, 1),
  [91] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array_type, 2, .production_id = 3),
  ...
  [113] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_method_parameters, 2),
  [115] = {.entry = {.count = 1, .reusable = true}}, SHIFT(45),
  [117] = {.entry = {.count = 1, .reusable = true}}, SHIFT(46),
  [119] = {.entry = {.count = 1, .reusable = true}}, SHIFT(47),
  [121] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_method_declaration, 4),
  [123] = {.entry = {.count = 1, .reusable = true}}, SHIFT(29),
  [125] = {.entry = {.count = 1, .reusable = true}}, SHIFT(11),
  [127] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_method_parameters, 3),
  [129] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_method_parameter, 2),
  [131] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_method_body, 2),
  [133] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_method_declaration, 5),
};
